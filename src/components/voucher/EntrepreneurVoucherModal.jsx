...
import { Ticket, CheckCircle, Loader2, ShoppingBag, MapPin, Phone, Tag, Plus, Minus, Package, MessageCircle } from 'lucide-react';
...
export default function EntrepreneurVoucherModal({
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(false);
    toast.success(useUnified ? 'Voucher único gerado com sucesso!' : `${quantity} voucher${quantity > 1 ? 's' : ''} gerado${quantity > 1 ? 's' : ''}!`);
